"""
Django settings for decentadmin project.
...
# Allow CORS requests from React frontend running on localhost:3000
CORS_ALLOWED_ORIGINS = [
    "http://localhost:3000",
]


ROOT_URLCONF = 'decentadmin.urls'
...
WSGI_APPLICATION = 'decentadmin.wsgi.application'
ASGI_APPLICATION = 'decentadmin.asgi.application'
